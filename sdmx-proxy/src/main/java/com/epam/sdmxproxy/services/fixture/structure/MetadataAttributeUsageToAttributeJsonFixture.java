...
@Slf4j
@Component
public class MetadataAttributeUsageToAttributeJsonFixture implements StructureFixture {
    ...
    public StructureFixtureType getType() {
        return StructureFixtureType.METADATA_ATTRIBUTE_USAGE_TO_ATTRIBUTE;
    }
